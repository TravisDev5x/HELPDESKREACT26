...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable($tableNames['roles'])) {
            ...
            // Existing roles table: ensure guard_name exists and is set.
            if (!Schema::hasColumn($tableNames['roles'], 'guard_name')) {
                $defaultGuard = config('auth.defaults.guard', 'web');
                Schema::table($tableNames['roles'], static function (Blueprint $table) use ($defaultGuard) {
            ...
            DB::table($tableNames['roles'])
                ...
                ->update(['guard_name' => config('auth.defaults.guard', 'web')]);
        }
    ...
    public function down(): void
    {
        ...
        // Do not drop roles table to avoid data loss for existing roles.
    }
};
