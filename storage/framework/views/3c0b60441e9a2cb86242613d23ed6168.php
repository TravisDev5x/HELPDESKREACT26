                                ...
                                <tr>
                                    <td style="padding: 24px;">
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="left">
                                            <tr>
                                                <td align="center" style="border-radius: 8px; background-color: #0f172a;">
                                                    <a href="<?php echo e($url); ?>" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 10px 20px; font-size: 0.875rem; font-weight: 500; color: #f8fafc; text-decoration: none;">
                                                        Verificar correo
                                                    </a>
                                                </td>
                                            </tr>
                                        ...
                                        <p style="margin: 8px 0 0 0; font-size: 0.8125rem;">
                                            <a href="<?php echo e($url); ?>" style="color: #3b82f6; text-decoration: underline; word-break: break-all;"><?php echo e($url); ?></a>
                                        </p>
                                    </td>
                                </tr>
                                <!-- Footer -->
...
<?php /**PATH C:\laragon\www\HelpdeskReact\resources\views/emails/verify-email.blade.php ENDPATH**/ ?>